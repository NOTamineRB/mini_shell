...
void chrono (int sig) { 
    ...
    execlp("open", "open", "https://github.com/NOTamineRB/mini_shell", NULL);
  ...
  if (fork() == 0)
    {
        ...
        execlp("/home/amine/Desktop/new/P S/linux(appel_systeme)/project/mini_shell/cmd", "/home/amine/Desktop/new/P S/linux(appel_systeme)/project/mini_shell/cmd", args[0], args[1], args[2], NULL);
        perror("Erreur lors de l'exécution de la commande.");
        exit(0);
    }
    wait(0);
